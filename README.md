...
<!-- Please read the https://github.com/linuxserver/docker-docker-compose/blob/alpine/.github/CONTRIBUTING.md -->
...
[![Jenkins Build](https://img.shields.io/jenkins/build?labelColor=555555&logoColor=ffffff&style=for-the-badge&jobUrl=https%3A%2F%2Fci.linuxserver.io%2Fjob%2FDocker-Pipeline-Builders%2Fjob%2Fdocker-docker-compose%2Fjob%2Falpine%2F&logo=jenkins)](https://ci.linuxserver.io/job/Docker-Pipeline-Builders/job/docker-docker-compose/job/alpine/)
...
Simply pulling `lscr.io/linuxserver/docker-compose:alpine` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
docker run --rm \
  ...
  -v "$PWD:$PWD" \
  -w="$PWD" \
  lscr.io/linuxserver/docker-compose:alpine \
  up
```
...
```
sudo curl -L --fail https://raw.githubusercontent.com/linuxserver/docker-docker-compose/alpine/run.sh -o /usr/local/bin/docker-compose
...
* image version number
  * `docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/docker-compose:alpine`
...
* Update the image: `docker pull lscr.io/linuxserver/docker-compose:alpine`
...
docker build \
  --no-cache \
  --pull \
  -t lscr.io/linuxserver/docker-compose:alpine .
```
...
* **15.03.22:** - Add v2 branch. Change master to only fetch v1 releases. Change alpine to only fetch v1 releases.
